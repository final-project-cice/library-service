        ...
        this.mockMvc.perform(
                ...
                .andDo(document("books/add",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("_links.get.href").description("Link to get the book resource by id."),
                                fieldWithPath("_links.getByPage.href").description("Link to get the book resource by pate."),
                                fieldWithPath("_links.getByPage.templated").ignored(),
                                fieldWithPath("_links.getByPageAndSort.href").description("Link to get the book resource by page and sort."),
                                fieldWithPath("_links.getByPageAndSort.templated").ignored(),
                                fieldWithPath("_links.update.href").description("Link to update the book resource."),
                                fieldWithPath("_links.delete.href").description("Link to delete the book resource.")
                        ),
                        links(
                                halLinks(),
                                linkWithRel("self").description("Link to self(add the book) resource."),
                                linkWithRel("get").description("Link to get the book resource by id."),
                                linkWithRel("getByPage").description("Link to get the book resource by page."),
                                linkWithRel("getByPageAndSort").description("Link to get the book resource by page and sort."),
                                linkWithRel("update").description("Link to update the book resource."),
                                linkWithRel("delete").description("Link to delete the book resource.")
                        ))
                );
    }
...
//                .andExpect(content().string(containsString(responseBodyContent)))
                .andDo(print())
                .andDo(document("books/getByPage",
                        pathParameters(
    ...
    @Sql(value = {"/Book_Empty_Before.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
    @Test
    public void getByPage_NotFoundBook() throws Exception {
    ...
    @Sql(value = {"/Book_After.sql"}, executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
    @Test
    public void getByPageAndSort() throws Exception {
...
//                .andExpect(content().string(containsString(responseBodyContent)));
                .andDo(print())
                .andDo(document("books/getByPageAndSort",
                        pathParameters(
                                parameterWithName("startPage").description("zero-based page index, must not be negative"),
                                parameterWithName("pageSize").description("the size of the page to be returned, must be greater than 0"),
                                parameterWithName("sortOrder").description("The value of the search of the Book.")
                        ),
                        responseFields(
                                fieldWithPath("content").description("Object that represent JPA pagination."),
                                fieldWithPath("content.[]").description("Array of the values Book that represent page."),
    ...
    @Sql(value = {"/Book_Empty_Before.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
    @Test
    public void getByPageAndSort_NotFoundBook() throws Exception {
        ...
        this.mockMvc.perform(
                ...
                .andDo(document("books/update",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("_links.add.href").description("Link to add the book resource."),
                                fieldWithPath("_links.get.href").description("Link to get the book resource."),
                                fieldWithPath("_links.getByPage.href").description("Link to get the book resource by pate."),
                                fieldWithPath("_links.getByPage.templated").ignored(),
                                fieldWithPath("_links.getByPageAndSort.href").description("Link to get the book resource by page and sort."),
                                fieldWithPath("_links.getByPageAndSort.templated").ignored(),
        ...
        this.mockMvc.perform(
                ...
                .andDo(document("books/deleteById",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("_links.add.href").description("Link to add the book resource."),
                                fieldWithPath("_links.get.href").description("Link to get the book resource by id."),
                                fieldWithPath("_links.getByPage.href").description("Link to get the book resource by page."),
                                fieldWithPath("_links.getByPage.templated").ignored(),
                                fieldWithPath("_links.getByPageAndSort.href").description("Link to get the book resource by page and sort."),
                                fieldWithPath("_links.getByPageAndSort.templated").ignored(),
                                fieldWithPath("_links.update.href").description("Link to update the book resource."),
