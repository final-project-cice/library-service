        ...
        this.mockMvc.perform(
                ...
                .andDo(document("comments/deleteByCommentId",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("date").description("Date of the comment."),
                                fieldWithPath("subComments.[]").description("The array of sub comments by the comment."),
                                fieldWithPath("subComments.[].subCommentId").description("The id of subComment."),
                                fieldWithPath("subComments.[].userId").description("The id of user whu created this subComment."),
                                fieldWithPath("subComments.[].text").description("The text of the subComment."),
                                fieldWithPath("subComments.[].date").description("The date of the subComment."),
        ...
        this.mockMvc.perform(
                ...
                .andDo(document("comments/deleteAllCommentsByBookId",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("[].subComments.[].text").description("The text of the subComment."),
                                fieldWithPath("[].subComments.[].date").description("The date of the subComment."),
                                fieldWithPath("[].subComments.[].links").ignored(),
