...
values (1, TO_DATE('01-NOV-2019', 'DD-MON-YYYY'), 'test sub comment First', 1, 1);
insert into sub_comment_comment (id, date_of_creation, text, user_id, comment_id)
values (2, TO_DATE('02-NOV-2019', 'DD-MON-YYYY'), 'test sub comment Second', 1, 1);
insert into sub_comment_comment (id, date_of_creation, text, user_id, comment_id)
values (3, TO_DATE('03-NOV-2019', 'DD-MON-YYYY'), 'test sub comment Three', 1, 1);
